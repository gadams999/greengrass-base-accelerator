...
export class CustomResourceGreengrassGroupRole extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, props: CustomResourceGreengrassGroupRoleProps) {
    super(scope, id);
    ...
    const resource = new cfn.CustomResource(this, 'Resource', {
      provider: cfn.CustomResourceProvider.fromLambda(new lambda.SingletonFunction(this, 'Singleton', {
        ...
        code: lambda.Code.fromAsset('cr-greengrass-group-role/cr_greengrass_group_role'),
        handler: 'index.main',
